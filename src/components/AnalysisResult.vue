...
const buildChartPalette = () => [
  resolveCssVar('--primary-color', '#8B7CF6'),
  resolveCssVar('--success-color', '#2FC98E'),
  resolveCssVar('--warning-color', '#F0AC42'),
  resolveCssVar('--danger-color', '#F0708A'),
  resolveCssVar('--accent-color', '#3FD8C8'),
  resolveCssVar('--primary-color', '#8B7CF6'),
  resolveCssVar('--border-color-strong', '#D6D2F5'),
];
...
.pie-block-title.accent-ai { color: #7c3aed; }
...
.belanja-col-header.accent-ai { color: #7c3aed; border-bottom-color: #ede9fe; }
