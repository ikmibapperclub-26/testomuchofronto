...
.avatar-admin { background: linear-gradient(135deg, #6366f1, #3b82f6); color: white; }
...
.btn-row-edit:hover { background: rgba(99,102,241,0.1); border-color: #6366f1; color: #6366f1; }
...
.api-config-info-banner i { width: 20px; height: 20px; color: #6366f1; flex-shrink: 0; margin-top: 2px; }
