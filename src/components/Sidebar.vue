  ...
  <aside class="sidebar">
    <div class="sidebar-header">
      ...
      <div class="logo-text">
        ...
        <span class="logo-subtitle">oleh Tim IT Bapper Club</span>
      </div>
    </div>
...
.nav-item-admin {
  position: relative;
  background: linear-gradient(135deg, rgba(99,102,241,0.08), rgba(59,130,246,0.08)) !important;
...
.role-tag-admin { background: rgba(99,102,241,0.12); color: #6366f1; }
